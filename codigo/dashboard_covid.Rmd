...
```{r}
valueBox(paste(df_obitos_sexo$Label[1],' - ', format(df_obitos_sexo$Percentual[1]), '%'), caption = "Sexo", color="blue")
...
```{r}
valueBox(df_obitos_escol$Label[1], caption = "Escolaridade", color="green")
...
```{r}
valueBox('--', caption = "Sexo", color="blue")
...
```{r}
valueBox('--', caption = "Escolaridade", color="green")
...
```{r}
valueBox(paste(media_idade_obitos_2023, ' anos'), caption = "Média Idade", color="blue")
