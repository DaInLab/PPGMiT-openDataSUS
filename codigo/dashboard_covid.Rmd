...
df_covid_obitos<- read.csv('D:/GoogleDrive/Mestrado/PPGMiT-openDataSUS/dados/covid_obitos.csv', sep=";")
...
```{r}
valueBox(valueBox(format(num_obitos_2021, big.mark = "."), caption = "Numero Óbitos", color="red"), caption = "Numero Óbitos", color="red")
