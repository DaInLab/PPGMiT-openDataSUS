 ...
 renderValueBox({
   ...
   if (total_notificacoes == 0) {
      valueBox(value = tags$p("---", style = "color:lightgray; "),
              caption = tags$p("Total Notificações", style = "color:gray; "),
              icon = icon("list"), color ="white")
   } else {
      valueBox(value = format(total_notificacoes, big.mark = "."),
               caption = tags$p("Total Notificações", style = "color:white; "),
...
if (nrow(dados) == 0) { chart <- plot_ly(df_sexo, labels = ~0, values = ~0, type = "pie",
...
renderValueBox({
   ...
   if (total_obito == 0) {
     valueBox(value = tags$p("---", style = "color:lightgray; "),
              captio = tags$p("Total Óbitos", style = "color:lightgray; "),
              icon = icon("list"), color ="white")
   } else {
      valueBox(value = format(total_obito, big.mark = "."),icon = icon("list"), color ="red")
     }
...
renderValueBox({
   ...
   if (media_idade == 0 | is.nan(media_idade)) {
     valueBox(value = tags$p("---", style = "color:lightgray; "),
              captio = tags$p("Óbitos Média Idade", style = "color:lightgray; "),
              icon = icon("list"), color ="white")
   } else {
...
renderValueBox({ 
   ...
   if (sum(sexo) != 0 ) {                       
         switch(maior_sexo[1],
              ...
              captio = tags$p("Óbitos Sexo", style = "color:lightgray; "),
              icon = icon("list"), color ="white")}
  ...
  "2023" = {escola <- 
   ...
   switch(maior_escola[1],
          ...
          "7" = {valueBox(value = "Ignorado     ", icon = icon("list"), color ="darkblue")}
              ...
              captio = tags$p("Óbitos Escolaridade", style = "color:lightgray; "),
              icon = icon("list"), color ="white")}
  ...
  "2023" = {raca <- c(sum(dados$qt_raca_1_2023), sum(dados$qt_raca_2_2023), sum(dados$qt_raca_3_2023),sum(dados$qt_raca_4_2023), sum(dados$qt_raca_5_2023),sum(dados$qt_raca_9_2023))}
   ...
   if (sum(raca) != 0 ) {                       
         switch(maior_raca[1],
              ...
              captio = tags$p("Óbitos Raça", style = "color:lightgray; "),
              icon = icon("list"), color ="white")}
})
